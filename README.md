...
>[!IMPORTANT]
>It will **only** stop mass deauth flood, not targeted deauth, which mean AntiDeauther would out of its scope. Seem likes preventing some kids try to use fake gun.
>
